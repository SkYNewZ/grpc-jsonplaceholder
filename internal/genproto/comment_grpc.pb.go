...
type CommentServiceClient interface {
	...
	ListComments(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListCommentsResponse, error)
}
...
func (c *commentServiceClient) GetComment(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*Comment, error) {
	out := new(Comment)
	err := c.cc.Invoke(ctx, "/jsonplaceholder.v1.CommentService/GetComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentServiceClient) ListComments(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListCommentsResponse, error) {
	out := new(ListCommentsResponse)
	err := c.cc.Invoke(ctx, "/jsonplaceholder.v1.CommentService/ListComments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommentServiceServer interface {
	...
	ListComments(context.Context, *Empty) (*ListCommentsResponse, error)
...
func (UnimplementedCommentServiceServer) ListComments(context.Context, *Empty) (*ListCommentsResponse, error) {
...
func _CommentService_GetComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jsonplaceholder.v1.CommentService/GetComment",
	}
...
func _CommentService_ListComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jsonplaceholder.v1.CommentService/ListComments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).ListComments(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "jsonplaceholder.v1.CommentService",
